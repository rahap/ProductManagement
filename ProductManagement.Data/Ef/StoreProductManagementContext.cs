...
{
    public class StoreProductManagementContext : DbContext, IContext
    {
        public StoreProductManagementContext(string connectionString) : base(GetOptions(connectionString))
        {
        }
